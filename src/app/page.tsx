...
export default function homepage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="bg-[#F5F6F7] h-[92vh] flex flex-row justify-center pt-5">
        <div className="min-w-[50vw] bg-[#FFFFFF] rounded-2xl mr-10">
          <div className="flex flex-col">
            <div className="flex flex-row min-h-[8vh] items-center space-x-10 pl-10">
              <div
              ...
              >
                <div className={tab == 0 ? "pb-2  text-black" : "pb-2"}>
                  Home
                </div>
